...
/// @notice This interface defines the functions that the HumanResources contract musti mplement
/// The contract must be able to register employees , terminate them , and allow mployees to withdraw their salary
...
interface IHumanResources {
    ...
    /// This means that after 2 days , the employee will be able to withdraw 2/7 th of is weekly salary
